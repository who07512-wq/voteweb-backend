...
router.post('/', requireAdmin, studentController.create.bind(studentController));

// PATCH /api/v1/admin/students/:id - Update student (admin only)
router.patch('/:id', requireAdmin, studentController.update.bind(studentController));

// PATCH /api/v1/admin/students/:id/status - Update student status (admin only)
router.patch('/:id/status', requireAdmin, studentController.updateStatus.bind(studentController));
